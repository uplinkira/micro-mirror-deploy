...
- 页面脚本语法检查
  - `cd D+20260314+goat/micro-mirror-deploy && awk '/<script type="module">/{flag=1;next}/<\\/script>/{flag=0}flag' index.html > /tmp/micro_mirror_deploy_check.mjs && node --check /tmp/micro_mirror_deploy_check.mjs`
...
- `cd D+20260314+goat/micro-mirror-deploy && node scripts/generate-agentkit-demo-assets.mjs`
